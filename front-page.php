...
<main class="site-main">
    ...
    <section class="hero" id="home">
        ...
        <div class="container hero-content">
            <div class="hero-tag animate-fade-up">
                <span class="dot"></span>
            ...
            <p class="hero-subcopy animate-fade-up delay-1">
                <?php _e('あなたのビジネスの想いを、', 'portfolio-pro'); ?><br>
                <?php _e('美しく機能的なWebサイトとして丁寧に形にします。', 'portfolio-pro'); ?>
            </p>
            <p class="hero-desc animate-fade-up delay-2" style="display:none;">
            ...
            <div class="hero-actions animate-fade-up delay-3">
                ...
                <a href="#contact" class="btn btn-ghost btn-lg"><?php _e('Get in Touch', 'portfolio-pro'); ?></a>
            </div>
            <?php /* 実績カウンター：非表示 */ ?>
        </div>
        ...
        <div class="container">
            <div class="about-grid">
                ...
                <div class="about-content reveal">
                    <div class="section-label"><?php _e('About Me', 'portfolio-pro'); ?></div>
                    <h2 class="section-title"><?php _e('Web制作で<br><span class="text-gradient">ビジネスを加速</span>します', 'portfolio-pro'); ?></h2>
                    <p class="about-text">
<?php _e('はじめまして。大学では工学部の情報系を専攻し、プログラミングやWebの基礎を体系的に学びました。現在はWebデザイナー／デベロッパーとして、WordPressを中心にコーポレートサイトやLPの制作に取り組んでいます。', 'portfolio-pro'); ?>
                    ...
                    <div class="skills-grid">
                        ...
                        <div class="skill-item">
                            ...
                            <div class="skill-bar">
                                <div class="skill-fill" data-width="<?php echo esc_attr($skill['level']); ?>"></div>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="about-actions">
                        <a href="#contact" class="btn btn-primary"><?php _e('お問い合わせはこちら', 'portfolio-pro'); ?></a>
    ...
    <section class="services section" id="services">
        <div class="container">
            <div class="section-header reveal">
                <div class="section-label"><?php _e('Services', 'portfolio-pro'); ?></div>
                <h2 class="section-title"><?php _e('提供できる<span class="text-gradient">サービス</span>', 'portfolio-pro'); ?></h2>
            </div>
			
            <div class="services-bento reveal">
                <a href="<?php echo esc_url(home_url('/wordpress/')); ?>" style="display:block;" class="bento-card bento-large">
                    ...
                    <h3><?php _e('WordPress 制作', 'portfolio-pro'); ?></h3>
                    <p><?php _e('オリジナルテーマの制作からプラグイン開発まで。管理しやすく高速なWordPressサイトを構築します。', 'portfolio-pro'); ?></p>
                    <div class="bento-tags">
                        <span>オリジナルテーマ</span><span>プラグイン開発</span><span>高速化</span>
                    </div>
                </a>

                <a href="<?php echo esc_url(home_url('/web-design/')); ?>" style="display:block;" class="bento-card">
                    <div class="bento-icon">
                    ...
                    <h3><?php _e('Webデザイン', 'portfolio-pro'); ?></h3>
                    <p><?php _e('ブランドに合わせたオリジナルデザイン。Figmaでのプロトタイプ作成も対応。', 'portfolio-pro'); ?></p>
				</a>

                <a href="<?php echo esc_url(home_url('/lp/')); ?>" style="display:block;" class="bento-card">
                    ...
                    <h3><?php _e('LP制作', 'portfolio-pro'); ?></h3>
                    <p><?php _e('CV最大化を意識した高品質なランディングページを制作。A/Bテスト対応も可能。', 'portfolio-pro'); ?></p>
				</a>
                ...
                <div class="bento-card">
                    ...
                    <h3><?php _e('SEO 対策', 'portfolio-pro'); ?></h3>
                    <p><?php _e('技術的SEO・コンテンツSEOを組み合わせた包括的な検索対策を提供します。', 'portfolio-pro'); ?></p>
                </div>
                ...
                <div class="bento-card bento-wide">
                    ...
                    <h3><?php _e('保守・運用サポート', 'portfolio-pro'); ?></h3>
                    <p><?php _e('制作後の定期メンテナンス、セキュリティ対策、コンテンツ更新のサポートまで、長期的なパートナーとして対応します。', 'portfolio-pro'); ?></p>
                    <div class="bento-tags">
                        <span>月次レポート</span><span>セキュリティ</span><span>バックアップ</span><span>更新対応</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="works section" id="works">
        <div class="container">
            <div class="section-header reveal">
                <div class="section-label"><?php _e('Portfolio', 'portfolio-pro'); ?></div>
                <h2 class="section-title"><?php _e('制作<span class="text-gradient">実績</span>', 'portfolio-pro'); ?></h2>
                <p class="section-desc"><?php _e('これまでに手がけた主要プロジェクトをご紹介します', 'portfolio-pro'); ?></p>
            </div>
    ...
    <section class="process section" id="process">
        <div class="container">
            <div class="section-header reveal">
                <div class="section-label"><?php _e('Process', 'portfolio-pro'); ?></div>
                <h2 class="section-title"><?php _e('制作の<span class="text-gradient">流れ</span>', 'portfolio-pro'); ?></h2>
            </div>
        ...
        <div class="container">
            <div class="contact-wrapper reveal">
                <div class="contact-info">
                    <div class="section-label"><?php _e('Contact', 'portfolio-pro'); ?></div>
                    <h2 class="section-title"><?php _e('お気軽に<br><span class="text-gradient">ご相談ください</span>', 'portfolio-pro'); ?></h2>
                ...
                <div class="contact-form-wrapper">
                    ...
                    if ( shortcode_exists( 'contact-form-7' ) ) {
                        ...
                        if ( $cf7_id ) {
                            ...
                            echo '<p class="cf7-notice">' . __( 'Contact Form 7 でフォームを作成してください。', 'portfolio-pro' ) . '</p>';
                        }
                    } else {
                        // CF7 未インストール時のプレースホルダー
                        ?>
                        <div class="cf7-placeholder">
